...
const initialState = [
  ...
  { data: { id: "3", label: "Цена за литр, р.", type: 'two', values: [{ value: 117, percent: '+8' }, { value: 125, percent: '+7.0%' }] }, position: { x: -550, y: 350 } },
  { data: { id: "4", label: "Объем, тыс.шт", type: 'one', values: [{ value: 6358247, percent: '+343916' }, { value: 6702163, percent: '+5.4%' }] }, position: { x: 550, y: 250 } },
  { data: { id: "5", label: "Цена за шт, р.", type: 'two', values: [{ value: 72, percent: '+3' }, { value: 75, percent: '+4.2%' }] }, position: { x: 700, y: 350 } },
  ...
  { data: { id: "7", label: "Средний чек, р.", type: 'one', values: [{ value: 170, percent: '+8' }, { value: 178, percent: '+4.7%' }] }, position: { x: 200, y: 350 } },
  { data: { id: "8", label: "Объем покупки, л.", type: 'two', values: [{ value: 1.46, percent: '-0.04' }, { value: 1.42, percent: '-2.7%' }] }, position: { x: -400, y: 650 } },
  ...
  { data: { id: "10", label: "Популяция, чел.", type: 'two', values: [{ value: 104581474, percent: '+0' }, { value: 104581474, percent: '+0.0%' }] }, position: { x: -220, y: 650 } },
  { data: { id: "11", label: "Пенетрация", type: 'one', values: [{ value: '57.0%', percent: '+3' }, { value: '60.0%', percent: '+5.3%' }] }, position: { x: 0, y: 650 } },
  { data: { id: "12", label: "Пенетрация 18+", type: 'one', values: [{ value: '27.0%', percent: '+3' }, { value: '30.0%', percent: '+11.1%' }] }, position: { x: 200, y: 650 } },
  { data: { id: "13", label: "Частота покупки", type: 'one', values: [{ value: 45.3, percent: '-0.3' }, { value: '45.0', percent: '-0.7%' }] }, position: { x: 400, y: 650 } },
  { data: { id: "14", label: "Объем покупки,шт", type: 'two', values: [{ value: 2.4, percent: '+1' }, { value: 3.4, percent: '+41.7%' }] }, position: { x: 600, y: 650 } },
...
// Обновляем значения в initialState
